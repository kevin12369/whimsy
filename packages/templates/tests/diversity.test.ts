...
describe('template diversity', () => {
  it('5 templates render() output is byte-level independent', () => {
    const hashes = TEMPLATES.map((t) => simpleHash(t.render(defaultTheme, cfg)));
