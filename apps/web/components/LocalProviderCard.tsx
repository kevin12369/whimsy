...
export function LocalProviderCard() {
  ...
  const [timeoutMs, setTimeoutMs] = useState(readLs(KEYS.timeoutMs, '60000'));
  ...
  return (
    <div className="border border-zinc-700 rounded p-3 flex flex-col gap-2 text-sm" data-testid="local-provider-card">
      ...
      <label className="text-zinc-300" htmlFor="local-timeout">Timeout (ms, 1000-120000, default 60000)</label>
